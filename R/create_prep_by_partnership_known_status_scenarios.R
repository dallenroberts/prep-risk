################################################################################
## Allen Roberts
## Create PrEP by partnership, requiring HIV+ to have known status, scenarios.csv file using KP tags
################################################################################
...
## Scenario filaname
scenarios_filename <- "scenarios_prep_by_partnership_known_status"
...
scenarios <- scenarios %>%
  mutate(Campaign = "campaign_prep_by_partnership_known_status.json",
